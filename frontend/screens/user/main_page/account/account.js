        ...
        <LinearGradient style={styles.linearGradient} colors={[COLORS.secondary, COLORS.primary]}>
            ...
            <View style={styles.bottomContainer}>
                <KeyboardAwareScrollView style={{marginVertical: 30}}>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate('ChangeEmail')}>
                    ...
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate('ChangeFirstName')}>
                        <Text style={styles.itemText}> Change your first name</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate('ChangeLastName')}>
                        <Text style={styles.itemText}> Change your last name</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate('DeleteAccount')}>
