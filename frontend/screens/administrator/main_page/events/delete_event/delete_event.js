...
const DeleteEvent = ({ navigation, route }) => {
    ...
    const handleSubmit = async () => {
        try{
            ...
            const response = await axios.delete(`http://${IP}:8080/api/event/delete-event`, {
                headers: {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.pink }}>
            ...
            <View style={styles.titleContainer}>
                ...
                <Text style={styles.titleText}>Delete Event</Text>
            </View>
            <View style={{ flex: 1, marginHorizontal: 22, marginTop: 20 }}>
                <View style={styles.itemContainer}>
                    <Text style={styles.itemText}>Are you sure you want to delete this event?</Text>
                </View>
                <Button
                    title="Yes"
