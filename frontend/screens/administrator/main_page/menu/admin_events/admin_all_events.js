...
const AdminAllEvents = ({ navigation }) => {
    ...
    const fetchEvents = async () => {
        ...
        try {
            ...
            const response = await axios.get(`http://${IP}:8080/api/event/find-events-by-admin`, {
                headers: {
