        ...
        <LinearGradient style={styles.linearGradient} colors={[COLORS.secondary, COLORS.primary]}>
            ...
            <View style={styles.bottomContainer}>
                <KeyboardAwareScrollView style={{marginVertical: 30}}>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate("AdminEvents")}>
                        <Text style={styles.itemText}> Home Page</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate("SelectAdminLocation")}>
                        <Text style={styles.itemText}> See Calendars</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate("AdminAllEvents")}>
                        <Text style={styles.itemText}> Your Events</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate("AdminLocations")}>
                        <Text style={styles.itemText}> Your Locations</Text>
                    </TouchableOpacity>
